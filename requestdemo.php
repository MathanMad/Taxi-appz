                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="content-block">
                                                                <h2>A New Request Demo From Client</h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="content-block">
...
<head>
    ...
    <style>
      ...
      <script>
         setTimeout(function() {
             if (window.location.pathname.match('/request-demo')) {
                 ga('send', 'event', 'page', 'request demo');
             }
         }, 1000)
     </script>
...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu">
                        <i class="fa fa-bars icon-font" style="font-size: 25px;"></i>
                    </button>
            ...
            <div class="container ">
                <div class="row ">
                    <div class="col-md-8 col-xs-12 text-white ">
                        <h1 class=" u-Margin0 u-Weight300">Request Demo</h1>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <ol class="breadcrumb text-white u-MarginTop25 u-MarginBottom0 pull-right">
                            ...
                            <li class="active" class="fs-125"><span>Request Demo</span></li>
                        </ol>
                    </div>
    ...
    <div class="u-PaddingTop30 u-xs-PaddingTop30 u-PaddingBottom10 u-xs-PaddingBottom30">
        <div class="container">
            <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 ">
                <h5 class="text-center fs-125 u-Margin0">
                Thanks for requesting a demo – we appreciate you giving us a chance!
            </h5>
            </div>
        </div>
  ...
  <!--contact start-->
  <div class=" u-MarginTop30 u-MarginBottom30 " style="background: #590707;">
        <div class="container ">
            <form action="" method="post" onsubmit="return validateForm()">
                ...
                <div class="col-md-6 contact_form">
                    <div class="col-md-12">
                        ...
                        <span style="color: rgba(0, 0, 0, .55);text-align: justify;font-size: 17px;">Let's
                                Your</span> Request Demo
                        </h3>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="optradio" class="form-control">
                    ...
                    <div class="col-md-12 u-Padding20  ">
                        <button type="submit" name="form_submit"  onclick="myAction()" class="btn-block pricing_btn">Send Message</button>
                    </div>
                </div>
                ...
                <div class="col-md-6  u-MarginBottom20 u-MarginTop15">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <p class="text-white text-lg u-Weight600 ">
                            Taxiappz can help you with
                        </p>
                        <ul style="list-style: circle;color: white;">
                            <li>
                                <h5 style="margin: 4px 0;" class="fs-125">Product Discovery (Blueprint)</h5>
                            </li>
                            <li>
                                <h5 style="margin: 4px 0;" class="fs-125">Software Consultation</h5>
                            </li>
                            <li>
                                <h5 style="margin: 4px 0;" class="fs-125">Comprehensive Mobile Application</h5>
                            </li>
                            <li>
                                <h5 style="margin: 4px 0;" class="fs-125">User Centric Design (UX/ UI)</h5>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="contact-form">
                            <div class="row">
                                ...
                                <div class="col-x-12 col-sm-12 col-md-12">
                                    <div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="margin-bottom:0px">
                                        <input type="text" name="contact_name" class="mdl-textfield__input form-control" data-parsley-required="true" required value=""/>
                                        <label class="mdl-textfield__label" for="Mobilenumber">Name</label>
                                    </div>
                                    <?php if(isset($_SESSION['nameErr'])){?>
                                        <span class="showError" style="color: red;font-weight: bold;padding: 5px;"><?=$_SESSION['nameErr'];?></span>
                                    <?php }  ?>
                                </div> 
                                ...
                                <div class="col-x-12 col-sm-12 col-md-12">
                                    <div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="margin-bottom:0px">
                                        <input id="phone" onkeypress="return isNumberKey(event)" name="contact_mobile_number" type="tel" onchange="getNumber()" class="mdl-textfield__input form-control" required>
                                     
                                        <label class="mdl-textfield__label" for="Mobilenumber" style="padding-left:80px">Mobile Number</label>
                                    </div>
                                    <?php if(isset($_SESSION['phoneErr'])){?>
                                        <span class="showError" style="color: red;font-weight: bold;padding: 5px;"><?=$_SESSION['phoneErr'];?></span>
                                    <?php }  ?>
                                </div>
                                ...
                                <div class="col-x-12 col-sm-12 col-md-12">
                                    <div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="margin-bottom:0px">
                                        <input type="email" name="contact_email" class="mdl-textfield__input form-control" data-parsley-required="true" required />
                                        <label class="mdl-textfield__label" for="firstName">Email</label>
                                    </div>
                                    <?php if(isset($_SESSION['emailErr'])){?>
                                        <span class="showError" style="color: red;font-weight: bold;padding: 5px;"><?=$_SESSION['emailErr'];?></span>
                                    <?php }  ?>
                                </div>
                                ...
                                <div class="col-x-12 col-sm-12 col-md-12">
                                    <div class="form-group mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="margin-bottom:0px">
                                        <textarea class="mdl-textfield__input form-control " rows="4" name="contact_message" data-parsley-required="true" required></textarea>
                                        <label class="mdl-textfield__label" for="message">Message</label>
                                    </div>
                                    <?php if(isset($_SESSION['messageErr'])){?>
                                        <span class="showError" style="color: red;font-weight: bold;padding: 5px;"><?=$_SESSION['messageErr'];?></span>
                                    <?php }  ?>
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            if (isset($_GET["cat"])) {
                                                ...
                                                <div class="btn-group " data-toggle="buttons">
                                                    <label class="btn active">
                                                        <input type="radio" name='optradio' value="BASIC" <?php if ($_GET["cat"] == 1) {  ?> checked <?php
                                                                                                                                                    } ?> required><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span> BASIC</span>
                                                    </label>
                                                    <label class="btn">
                                                        <input type="radio" name='optradio' value="STANDARD" <?php if ($_GET["cat"] == 2) {  ?> checked <?php
                                                                                                                                                    } ?> required><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> STANDARD</span>
                                                    </label>
                                                    <label class="btn">
                                                        <input type="radio" name='optradio' value="ENTERPRISE" <?php if ($_GET["cat"] == 3) {  ?> checked <?php
                                                                                                                                                        } ?> required><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> ENTERPRISE</span>
                                                    </label>
                                                </div>
                                            <?php
                                                ...
                                                <div class="btn-group " data-toggle="buttons">
                                                    <label class="btn active">
                                                        <input type="radio" name='optradio' value="1" checked required><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span> BASIC</span>
                                                    </label>
                                                    <label class="btn">
                                                        <input type="radio" name='optradio' value="2" required><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> STANDARD</span>
                                                    </label>
                                                    <label class="btn">
                                                        <input type="radio" name='optradio' value="3" required><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> ENTERPRISE</span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-primary" name="form_submit" value="Send" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
  ...
  <!-- <aside id="sticky-social">
      <ul>
          <li><a href="skype:Taxiappz?chat" class="entypo-skype" target="_blank"><i class="fa fa-skype" aria-hidden="true"  style="font-size:30px;"></i></a></li>
      </ul>
  </aside> -->
