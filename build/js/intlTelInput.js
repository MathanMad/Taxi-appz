            ...
            function () {
                ...
                _createClass(Iti, [{
                    ...
                    value: function _setFlag(countryCode) {
                        ...
                        $('#dialcodes').val('+' + this.selectedCountryData.dialCode);
                        $('#countryName').val(this.selectedCountryData.name);
                        if (this.options.separateDialCode) {
